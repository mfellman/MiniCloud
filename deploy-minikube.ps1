...
.BaseName
            ...
            try {
                Invoke-RestMethod -Uri "$storageUrl/internal/upload/workflows/$name" -Method Post -ContentType "application/yaml" -InFile <#
.SYNOPSIS
    Start MiniCloud in minikube voor lokale end-to-end tests op Windows.
...
Write-Host "   minikube delete --profile $PROFILE             # verwijder cluster"
Write-Host ""
.FullName -ErrorAction Stop | Out-Null
            } catch {
                Write-Warn "      Fout bij uploaden van $name : $(<#
.SYNOPSIS
    Start MiniCloud in minikube voor lokale end-to-end tests op Windows.
...
.BaseName
            ...
            try {
                Invoke-RestMethod -Uri "$storageUrl/internal/upload/connections/$name" -Method Post -ContentType "application/yaml" -InFile <#
.SYNOPSIS
    Start MiniCloud in minikube voor lokale end-to-end tests op Windows.
